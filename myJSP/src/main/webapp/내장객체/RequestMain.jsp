...
<body>
	...
	<!-- 다양한 input태그를 사용하여 서버에 값을 전달 해봅시다 -->
        ...
        자기소개:
        <textarea name="intro" cols="30" rows="4" placeholder="자기소개를 입력해주세요."></textarea>
        <br />
	...
	<!--3.  HTML 요청 헤더정보를 읽어오는 방법 -->
	<h2>3.3.  HTML 요청 헤더정보를 읽어오는 방법</h2>
