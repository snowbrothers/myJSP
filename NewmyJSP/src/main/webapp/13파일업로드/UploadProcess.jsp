...
<%
	...
	//saveDirectory = "C:\\Users\\user\\git\\myJSP\\NewmyJSP\\src\\main\\webapp\\upload";
	...
	// 파일의 최대 크기(1MB)
		...
		try{
		    ...
		    if(res>0){
		    	out.print("등록 되었습니다.");
		    	// 리스트 페이지로 이동
		    	JSFunction.alertLocation("파일이 등록되었습니다.", "1FileList.jsp", out);
		    } else {
		    	out.print("DB등록에 실패 하였습니다.");
		    	// 이전페이지로 이동
		    	JSFunction.alertBack("파일 등록이 실패하였습니다.", out);
		    }
